        ...
        <div class="container-fluid">
            <div class="row bg-white" style="min-height: 700px;">
                <div class="col-md-5 bg-white py-3">
                    ...
                    <form action="setup.html" method="get" id="contactInfo" class="text-dark px-5 m-5" novalidate>
                        <div class="form-row p-0 m-0">
                            ...
                            <fieldset class="form-group col-md-6 pr-0">
                                ...
                                <input type="text" class="form-control" id="lastName" placeholder="Bros." required>
                                <div class="invalid-feedback">
                        ...
                        <fieldset class="form-group">
                            ...
                            <input type="text" class="form-control" id="address1" placeholder="Mario" required>
                            <div class="invalid-feedback">
